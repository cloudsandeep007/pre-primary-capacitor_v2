...
import { LogOut, Search, Users, Camera, CheckCircle2, Clock, BookOpen, QrCode, Activity } from 'lucide-react';
...
export function StaffDashboard({ staff, onLogout }: StaffDashboardProps) {
  ...
  // Deduplicated: one entry per student per day (latest wins)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold text-gray-800 mb-1">Staff Dashboard</h1>
            <p className="text-gray-500 text-sm">Select a student to log activity, view parent feed history, or scan gate pass</p>
          </div>
        </div>
