...
# We need to completely replace LedgerTable.tsx with a dumb presentational component.
ledger_table_content = """import React, { useState } from 'react';
...
with open('src/pages/admin/finance/components/LedgerTable.tsx', 'w', encoding='utf-8') as f:
    f.write(ledger_table_content)
print("Updated LedgerTable.tsx")
